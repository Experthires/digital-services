...
const serviceLibrary: ServiceCategory[] = [
  {
    ...
    services: [
      ...
      { icon: Sparkles, iconName: "Sparkles", title: "Machine Learning", description: "Custom ML models and data analysis solutions.", price: "Starting at $200", popular: true },
      { icon: Sparkles, iconName: "Sparkles", title: "AI Voice Synthesis", description: "Realistic AI voice generation for any project.", price: "Starting at $25", popular: true },
      { icon: Sparkles, iconName: "Sparkles", title: "AI Video Generation", description: "Create videos using AI tools and prompts.", price: "Starting at $50", popular: true },
      { icon: Sparkles, iconName: "Sparkles", title: "ChatGPT Prompt Engineering", description: "Optimized prompts for better AI outputs.", price: "Starting at $20", popular: true },
      { icon: Sparkles, iconName: "Sparkles", title: "AI Automation", description: "Automate tasks with AI-powered workflows.", price: "Starting at $75", popular: true },
    ]
  },
  {
    name: "Animation",
    ...
    services: [
      ...
      { icon: Film, iconName: "Film", title: "Whiteboard Animation", description: "Engaging whiteboard explainer videos.", price: "Starting at $25", popular: true },
      ...
      { icon: Film, iconName: "Film", title: "Motion Graphics", description: "Eye-catching motion graphics for videos.", price: "Starting at $40", popular: true },
      { icon: Film, iconName: "Film", title: "Lottie Animation", description: "Lightweight animations for web and apps.", price: "Starting at $30", popular: false },
    ]
  },
  {
    ...
    services: [
      ...
      { icon: Building, iconName: "Building", title: "Floor Plans", description: "Professional 2D and 3D floor plan design.", price: "Starting at $25", popular: true },
      ...
      { icon: Building, iconName: "Building", title: "3D Modeling", description: "Detailed 3D architectural models.", price: "Starting at $60", popular: true },
    ]
  },
  {
    ...
    services: [
      ...
      { icon: Palette, iconName: "Palette", title: "Business Cards", description: "Professional business card design.", price: "Starting at $10", popular: true },
      ...
      { icon: Palette, iconName: "Palette", title: "Brand Naming", description: "Creative naming for your brand or product.", price: "Starting at $50", popular: true },
      { icon: Palette, iconName: "Palette", title: "Merchandise Design", description: "Custom t-shirt and merchandise graphics.", price: "Starting at $20", popular: true },
    ]
  },
  {
    ...
    services: [
      ...
      { icon: BarChart, iconName: "BarChart", title: "Market Research", description: "In-depth market analysis and competitor research.", price: "Starting at $50", popular: true },
      ...
      { icon: Briefcase, iconName: "Briefcase", title: "Pitch Deck Creation", description: "Compelling investor presentations.", price: "Starting at $80", popular: true },
    ]
  },
  {
    name: "Copywriting",
    ...
    services: [
      ...
      { icon: PenTool, iconName: "PenTool", title: "Product Descriptions", description: "SEO-friendly product descriptions.", price: "Starting at $5", popular: true },
      ...
      { icon: PenTool, iconName: "PenTool", title: "Email Copy", description: "Persuasive email marketing copy.", price: "Starting at $15", popular: true },
    ]
  },
  {
    name: "Crypto & NFT",
    icon: TrendingUp,
    services: [
      { icon: TrendingUp, iconName: "TrendingUp", title: "NFT Art Creation", description: "Unique NFT artwork and collections.", price: "Starting at $50", popular: true },
      { icon: Code, iconName: "Code", title: "Smart Contract Development", description: "Ethereum and Solana smart contracts.", price: "Starting at $200", popular: true },
      { icon: TrendingUp, iconName: "TrendingUp", title: "Crypto Marketing", description: "Promote your crypto project effectively.", price: "Starting at $100", popular: false },
      { icon: TrendingUp, iconName: "TrendingUp", title: "Tokenomics Design", description: "Design your token economics.", price: "Starting at $150", popular: false },
      { icon: Globe, iconName: "Globe", title: "Web3 Development", description: "Build decentralized applications.", price: "Starting at $300", popular: true },
    ]
  },
  {
    name: "Data Analysis",
    ...
    services: [
      ...
      { icon: BarChart, iconName: "BarChart", title: "Power BI/Tableau", description: "Interactive business intelligence dashboards.", price: "Starting at $50", popular: true },
      ...
      { icon: BarChart, iconName: "BarChart", title: "Python Data Analysis", description: "Data analysis using Python and pandas.", price: "Starting at $35", popular: true },
    ]
  },
  {
    ...
    icon: Megaphone,
    services: [
      { icon: Megaphone, iconName: "Megaphone", title: "Google Ads", description: "PPC campaigns that drive results.", price: "Starting at $50", popular: true },
      { icon: Megaphone, iconName: "Megaphone", title: "Facebook Ads", description: "Targeted Facebook advertising campaigns.", price: "Starting at $40", popular: true },
      { icon: Megaphone, iconName: "Megaphone", title: "TikTok Marketing", description: "Viral TikTok marketing strategies.", price: "Starting at $30", popular: true },
      { icon: Megaphone, iconName: "Megaphone", title: "Marketing Strategy", description: "Complete digital marketing plans.", price: "Starting at $100", popular: true },
      { icon: Megaphone, iconName: "Megaphone", title: "Affiliate Marketing", description: "Set up profitable affiliate programs.", price: "Starting at $75", popular: false },
      { icon: Megaphone, iconName: "Megaphone", title: "Conversion Optimization", description: "Improve your website conversion rates.", price: "Starting at $60", popular: true },
    ]
  },
  {
    name: "E-commerce",
    ...
    services: [
      ...
      { icon: ShoppingCart, iconName: "ShoppingCart", title: "Amazon Store", description: "Amazon storefront setup and optimization.", price: "Starting at $50", popular: true },
      { icon: ShoppingCart, iconName: "ShoppingCart", title: "Product Listings", description: "Optimized product listings that convert.", price: "Starting at $10", popular: true },
      { icon: ShoppingCart, iconName: "ShoppingCart", title: "Dropshipping Setup", description: "Complete dropshipping business setup.", price: "Starting at $80", popular: true },
      { icon: ShoppingCart, iconName: "ShoppingCart", title: "Etsy Store Setup", description: "Launch your Etsy shop successfully.", price: "Starting at $40", popular: true },
    ]
  },
  {
    ...
    services: [
      ...
      { icon: Mail, iconName: "Mail", title: "Newsletter Design", description: "Beautifully designed email newsletters.", price: "Starting at $20", popular: true },
      ...
      { icon: Mail, iconName: "Mail", title: "Cold Email Outreach", description: "Effective cold email strategies.", price: "Starting at $25", popular: true },
      { icon: Mail, iconName: "Mail", title: "Klaviyo Setup", description: "E-commerce email marketing automation.", price: "Starting at $60", popular: false },
    ]
  },
  {
    name: "Gaming",
    ...
    services: [
      ...
      { icon: Gamepad2, iconName: "Gamepad2", title: "Game Coaching", description: "Professional gaming coaching sessions.", price: "Starting at $15", popular: true },
      { icon: Gamepad2, iconName: "Gamepad2", title: "Streaming Setup", description: "Complete streaming setup for gamers.", price: "Starting at $25", popular: true },
      { icon: Gamepad2, iconName: "Gamepad2", title: "Roblox Development", description: "Custom Roblox games and experiences.", price: "Starting at $100", popular: true },
      { icon: Gamepad2, iconName: "Gamepad2", title: "Unity Development", description: "Games built with Unity engine.", price: "Starting at $150", popular: false },
    ]
  },
  {
    ...
    services: [
      ...
      { icon: FileText, iconName: "FileText", title: "Flyer Design", description: "Professional flyers and brochures.", price: "Starting at $5", popular: true },
      ...
      { icon: Palette, iconName: "Palette", title: "Infographics", description: "Engaging infographic design.", price: "Starting at $20", popular: true },
      ...
      { icon: Palette, iconName: "Palette", title: "Social Media Graphics", description: "Eye-catching posts and banners.", price: "Starting at $10", popular: true },
      { icon: Palette, iconName: "Palette", title: "Presentation Design", description: "Professional PowerPoint and pitch decks.", price: "Starting at $25", popular: true },
    ]
  },
  {
    name: "Health & Fitness",
    icon: Heart,
    services: [
      { icon: Heart, iconName: "Heart", title: "Personal Training", description: "Custom workout plans and coaching.", price: "Starting at $25", popular: true },
      { icon: Heart, iconName: "Heart", title: "Nutrition Plans", description: "Personalized diet and meal plans.", price: "Starting at $30", popular: true },
      { icon: Heart, iconName: "Heart", title: "Fitness App Development", description: "Custom fitness tracking apps.", price: "Starting at $200", popular: false },
      { icon: Heart, iconName: "Heart", title: "Wellness Coaching", description: "Holistic health and wellness guidance.", price: "Starting at $40", popular: false },
    ]
  },
  {
    name: "Illustration",
    ...
    services: [
      ...
      { icon: Layers, iconName: "Layers", title: "Book Illustration", description: "Beautiful book and cover illustrations.", price: "Starting at $50", popular: true },
      ...
      { icon: Layers, iconName: "Layers", title: "Comics & Manga", description: "Comic and manga style artwork.", price: "Starting at $25", popular: true },
      { icon: Layers, iconName: "Layers", title: "Children's Book Art", description: "Whimsical illustrations for kids.", price: "Starting at $40", popular: true },
    ]
  },
  {
    name: "Legal Services",
    ...
    services: [
      ...
      { icon: FileText, iconName: "FileText", title: "Trademark Filing", description: "Trademark registration assistance.", price: "Starting at $100", popular: true },
      ...
      { icon: FileText, iconName: "FileText", title: "NDA Drafting", description: "Non-disclosure agreement creation.", price: "Starting at $25", popular: false },
    ]
  },
  {
    name: "Lifestyle",
    icon: Heart,
    services: [
      { icon: Heart, iconName: "Heart", title: "Life Coaching", description: "Personal development and guidance.", price: "Starting at $50", popular: true },
      { icon: Heart, iconName: "Heart", title: "Career Coaching", description: "Professional career advancement help.", price: "Starting at $40", popular: true },
      { icon: Heart, iconName: "Heart", title: "Relationship Advice", description: "Dating profile and communication tips.", price: "Starting at $20", popular: false },
      { icon: Heart, iconName: "Heart", title: "Astrology Readings", description: "Personal astrology consultations.", price: "Starting at $15", popular: true },
    ]
  },
  {
    ...
    services: [
      ...
      { icon: Smartphone, iconName: "Smartphone", title: "Flutter Apps", description: "Beautiful cross-platform apps.", price: "Starting at $350", popular: true },
      { icon: Smartphone, iconName: "Smartphone", title: "App UI/UX Design", description: "Mobile app interface design.", price: "Starting at $100", popular: true },
      { icon: Smartphone, iconName: "Smartphone", title: "App Store Optimization", description: "Improve app rankings and downloads.", price: "Starting at $50", popular: true },
    ]
  },
  {
    name: "Music & Audio",
    ...
    services: [
      ...
      { icon: Music, iconName: "Music", title: "Mixing & Mastering", description: "Professional audio mixing and mastering.", price: "Starting at $30", popular: true },
      ...
      { icon: Music, iconName: "Music", title: "Jingles & Intros", description: "Catchy audio branding.", price: "Starting at $25", popular: true },
      { icon: Music, iconName: "Music", title: "Song Writing", description: "Original lyrics and melodies.", price: "Starting at $40", popular: true },
    ]
  },
  {
    name: "Photography",
    ...
    services: [
      ...
      { icon: Camera, iconName: "Camera", title: "Photo Restoration", description: "Restore old and damaged photos.", price: "Starting at $15", popular: true },
      { icon: Camera, iconName: "Camera", title: "Photo Manipulation", description: "Creative photo composites and edits.", price: "Starting at $20", popular: true },
    ]
  },
  {
    ...
    services: [
      ...
      { icon: Code, iconName: "Code", title: "API Development", description: "RESTful APIs and backend services.", price: "Starting at $75", popular: true },
      ...
      { icon: Code, iconName: "Code", title: "Automation Scripts", description: "Python and JavaScript automation.", price: "Starting at $30", popular: true },
      { icon: Code, iconName: "Code", title: "Cybersecurity", description: "Security audits and penetration testing.", price: "Starting at $100", popular: true },
    ]
  },
  {
    name: "SEO Services",
    ...
    services: [
      ...
      { icon: TrendingUp, iconName: "TrendingUp", title: "Keyword Research", description: "Strategic keyword research and analysis.", price: "Starting at $25", popular: true },
      ...
      { icon: TrendingUp, iconName: "TrendingUp", title: "Local SEO", description: "Optimize for local search results.", price: "Starting at $40", popular: true },
      { icon: TrendingUp, iconName: "TrendingUp", title: "SEO Audit", description: "Comprehensive website SEO analysis.", price: "Starting at $35", popular: true },
      { icon: TrendingUp, iconName: "TrendingUp", title: "YouTube SEO", description: "Rank higher on YouTube search.", price: "Starting at $30", popular: true },
    ]
  },
  {
    name: "Social Media",
    ...
    services: [
      ...
      { icon: Share2, iconName: "Share2", title: "Influencer Marketing", description: "Connect with relevant influencers.", price: "Starting at $100", popular: true },
      ...
      { icon: Share2, iconName: "Share2", title: "TikTok Content", description: "Viral TikTok video creation.", price: "Starting at $25", popular: true },
      { icon: Share2, iconName: "Share2", title: "Instagram Growth", description: "Organic Instagram follower growth.", price: "Starting at $35", popular: true },
    ]
  },
  {
    name: "Translation",
    ...
    services: [
      ...
      { icon: Globe, iconName: "Globe", title: "Website Localization", description: "Adapt your website for global audiences.", price: "Starting at $50", popular: true },
      ...
      { icon: Globe, iconName: "Globe", title: "Transcription", description: "Audio to text transcription services.", price: "Starting at $10", popular: true },
      { icon: Globe, iconName: "Globe", title: "Book Translation", description: "Full book and novel translation.", price: "Starting at $100", popular: false },
    ]
  },
  {
    name: "UI/UX Design",
    ...
    services: [
      ...
      { icon: Layers, iconName: "Layers", title: "Wireframing", description: "UX wireframes and prototypes.", price: "Starting at $30", popular: true },
      { icon: Layers, iconName: "Layers", title: "Design Systems", description: "Scalable design systems.", price: "Starting at $150", popular: false },
      { icon: Layers, iconName: "Layers", title: "Figma Design", description: "Professional Figma UI designs.", price: "Starting at $40", popular: true },
    ]
  },
  {
    ...
    services: [
      ...
      { icon: Video, iconName: "Video", title: "Promotional Videos", description: "Compelling promotional content.", price: "Starting at $75", popular: true },
      ...
      { icon: Video, iconName: "Video", title: "Product Videos", description: "Showcase your products beautifully.", price: "Starting at $40", popular: true },
      { icon: Video, iconName: "Video", title: "Testimonial Videos", description: "Professional customer testimonials.", price: "Starting at $30", popular: true },
    ]
  },
  {
    ...
    services: [
      ...
      { icon: Users, iconName: "Users", title: "Customer Service", description: "Professional customer support.", price: "Starting at $15", popular: true },
      { icon: Users, iconName: "Users", title: "Research", description: "In-depth research on any topic.", price: "Starting at $20", popular: true },
      ...
      { icon: Users, iconName: "Users", title: "Lead Generation", description: "Find and qualify potential clients.", price: "Starting at $25", popular: true },
    ]
  },
  {
    name: "Web Design",
    ...
    services: [
      ...
      { icon: Globe, iconName: "Globe", title: "Webflow Design", description: "Modern Webflow websites.", price: "Starting at $75", popular: true },
      ...
      { icon: Globe, iconName: "Globe", title: "Website Redesign", description: "Refresh your existing website.", price: "Starting at $80", popular: true },
      { icon: Globe, iconName: "Globe", title: "Wix Website", description: "Professional Wix website creation.", price: "Starting at $40", popular: true },
    ]
  },
  {
